...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#EDEAE3] selection:bg-[#2A5C3F]/15">
      ...
      <a
        href="https://wa.me/393518302839"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 right-8 z-[500] w-14 h-14 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:shadow-[0_0_35px_rgba(37,211,102,0.6)] hover:scale-110 transition-all duration-300 active:scale-95"
      ...
      <CVAnalysisModal isOpen={isCVModalOpen} onClose={() => setIsCVModalOpen(false)} />
