      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-10 relative z-10">
          ...
          <div>
            ...
            <p className="text-white/30 text-[10px] tracking-[0.25em] font-black mb-5">STEP 2 — ORE MANUALI A SETTIMANA</p>
            <div className="flex items-center gap-5 mb-4">
              ...
              <div className="flex-1 text-center">
                <span className="text-white font-black" style={{ fontFamily: 'Outfit, sans-serif', fontSize: '52px', lineHeight: 1 }}>{hours}</span>
                <span className="text-white/35 text-sm ml-2">ore / sett.</span>
              </div>
              <button
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <div className="mb-6">
                ...
                <span className="text-white/40 text-base ml-2">ore risparmiate / settimana</span>
              </div>

              <div className="space-y-3 mb-8">
                <div className="h-px bg-white/6" />
                <div className="flex justify-between items-center py-1">
                  <span className="text-white/40 text-sm">Al mese</span>
                  <span className="text-white font-black text-2xl">{savedMonthly} ore</span>
                </div>
                <div className="h-px bg-white/6" />
                <div className="flex justify-between items-center py-1">
                  <span className="text-white/40 text-sm">Giorni lavorativi recuperati</span>
                  <span className="text-white font-black text-2xl">{savedDays} giorni</span>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <div className="text-white font-black leading-none mb-1" style={{ fontFamily: 'Outfit, sans-serif', fontSize: '36px' }}>
                        −80<span className="text-[#3B82F6]">%</span>
                      </div>
                      <p className="text-white/40 text-sm leading-snug">
                        di tempo perso su attività manuali.<br />
                        <span className="text-white/60">Il tuo team torna a fare business.</span>
                      </p>
                    </div>
                  </div>
...
const FAQSection: React.FC = () => {
  ...
  return (
    <section className="py-24 relative" style={{ background: '#050d1a' }}>
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/5 to-transparent" />
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">

        <Reveal className="text-center mb-14">
          <p className="text-[#4A9FFF] text-[10px] tracking-[0.3em] font-black mb-4">— FAQ —</p>
          <h2 className="text-white tracking-tight" style={{ fontFamily: 'Manrope, sans-serif', fontSize: '60px', fontWeight: 400, lineHeight: '60px' }}>
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      border: `1px solid ${open === i ? '#3B82F6' : 'rgba(255,255,255,0.12)'}`,
                      color: open === i ? '#3B82F6' : 'rgba(255,255,255,0.35)',
                ...
                >
                  <div className="overflow-hidden">
                    <p className="px-7 pb-6 text-white/45 text-sm leading-relaxed">{faq.a}</p>
                  </div>
                </div>
              </div>
            </Reveal>
    ...
    <div style={{ background: '#050d1a' }} className="min-h-screen selection:bg-[#3B82F6]/20 overflow-x-hidden">
      ...
      <section className="relative pt-36 pb-0 px-4 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-7 border border-[#3B82F6]/25 bg-[#3B82F6]/8 transition-all duration-600 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-3'}`}>
            ...
            <span className="text-[#3B82F6] text-[10px] tracking-[0.25em] font-black">AUTOMAZIONE PROCESSI</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {/* IL PROBLEMA */}
              <div className="neon-card rounded-2xl border border-white/6 bg-[#0a1628] p-8 relative overflow-hidden">
                <h3 className="text-white font-black font-montserrat mb-6" style={{ fontSize: '30px' }}>Il Problema</h3>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-white/35 text-sm leading-relaxed">
              ...
              {/* LA SOLUZIONE */}
              <div
                className="neon-card relative rounded-2xl border border-[rgba(59,130,246,0.4)] p-8 overflow-hidden"
              ...
              >
                ...
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,rgba(59,130,246,0.1)_0%,transparent_65%)] pointer-events-none" />
                ...
                <ul className="space-y-4 relative z-10">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-white/75 text-sm leading-relaxed">
                      <span className="flex-shrink-0 font-bold" style={{ color: '#0066FF' }}>✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              {/* I RISULTATI */}
              <div className="neon-card rounded-2xl border border-white/6 bg-[#0a1628] p-8 relative overflow-hidden">
                <h3 className="font-black font-montserrat mb-6" style={{ fontSize: '30px', color: '#FFFFFF' }}>I Risultati</h3>
                <ul className="space-y-4">
                  {[
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <Reveal key={i} delay={i * 100}>
                <div
                  className="neon-card relative rounded-2xl border border-white/6 bg-[#0a1628] p-8 h-full hover:-translate-y-1 transition-all duration-300 group overflow-hidden"
                ...
                >
                  ...
                  <div className="absolute top-0 left-0 right-0 h-px opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-transparent via-[#3B82F6]/40 to-transparent rounded-t-2xl" />
                  <div className="relative z-10">
                    <div className="text-[4rem] font-black font-montserrat leading-none mb-5" style={{ color: 'rgba(59,130,246,0.12)' }}>
                      {step.n}
                    </div>
                    <h3 className="text-white font-black text-lg font-montserrat mb-3 leading-snug">{step.title}</h3>
                    <p className="text-white/35 text-base leading-relaxed">{step.desc}</p>
                  </div>
                </div>
              </Reveal>
            ))}
            ...
            <Reveal delay={0}>
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-1 relative z-10">
                  ...
                  <div className="mb-2">
                    <span className="text-white font-black" style={{ fontFamily: 'Outfit, sans-serif', fontSize: '48px', lineHeight: 1 }}>€150</span>
            ...
            <Reveal delay={100}>
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-1 relative z-10">
                  ...
                  <div className="mb-2">
                    <span className="text-white font-black" style={{ fontFamily: 'Outfit, sans-serif', fontSize: '48px', lineHeight: 1 }}>€349</span>
                    <span className="text-white/40 text-sm ml-1">/mese + IVA</span>
                  </div>
                  <p className="text-white/25 text-xs mb-8">+ setup iniziale una tantum</p>
                  <ul className="space-y-3 mb-10 flex-1">
      ...
      <section className="py-24 relative" style={{ background: '#050d1a' }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center mb-14">
            <p className="text-[#4A9FFF] text-[10px] tracking-[0.3em] font-black mb-4">— FUNZIONALITÀ —</p>
            <h2 className="text-white tracking-tight" style={{ fontFamily: 'Manrope, sans-serif', fontSize: '60px', fontWeight: 400, lineHeight: '60px' }}>
          ...
          <Reveal delay={100}>
            <div className="neon-card rounded-2xl border border-white/6 overflow-hidden relative" style={{ background: '#0a1628' }}>
              {features.map((feat, i) => (
                <div
                  key={i}
                  className={`flex items-center gap-4 px-7 py-4 hover:bg-white/[0.025] transition-colors duration-200 ${i < features.length - 1 ? 'border-b border-white/5' : ''}`}
                >
                  <span className="w-5 h-5 rounded-full bg-[#3B82F6]/12 border border-[#3B82F6]/25 flex items-center justify-center flex-shrink-0">
                    <Check className="w-3 h-3 text-[#3B82F6]" />
                  </span>
                  <span className="text-white/55 text-base">{feat}</span>
                </div>
              ))}
            </div>
          </Reveal>
...
const ActivityVisual: React.FC = () => (
  <div className="absolute inset-0 flex flex-col justify-center px-7 py-8 gap-2">
    <p className="text-[9px] tracking-[0.25em] font-black text-white/20 mb-3">ATTIVITÀ RECENTI</p>
    {ACTIVITIES.map((a, i) => (
      <div
        key={i}
      ...
      >
        <span className="text-[9px] text-white/25 font-mono w-8 flex-shrink-0">{a.time}</span>
        <span className="text-[10px] text-white/45 flex-1 leading-snug">{a.text}</span>
        {a.done
