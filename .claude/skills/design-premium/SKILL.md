...
## PROGETTO SPECIFICO — PatrickAI Automation

### Colori FISSI
- Sfondo: #0A0F1E e #000000
- Accento: #4A90D9 (blu)
- Testo: #FFFFFF
- NO viola, NO giallo, NO verde

### Stack esistente
- React/TSX già installato
- Tailwind CSS già configurato
- Non reinstallare dipendenze già presenti
